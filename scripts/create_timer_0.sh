...
# Путь к файлу
SERVICE_PATH="/etc/systemd/system/ffmpeg_capture_0.timer"
...
Description=Capture ffmpeg video from camera 0
...
WantedBy=timers.target"
    ...
    sudo systemctl enable ffmpeg_capture_0.timer
    sudo systemctl start ffmpeg_capture_0.timer
    sudo systemctl status ffmpeg_capture_0.timer
